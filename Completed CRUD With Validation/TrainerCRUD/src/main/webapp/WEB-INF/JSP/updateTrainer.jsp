...
<html>
    ...
    <body>
        <h1 style=" text-align: center">Please Update Trainers Details</h1>
        <br>
        <br>
        <hr>
        <br>
        ...
        <springForm:form  action="doUpdateTrainer" method="post" modelAttribute="newTrainer">
            ...
            Name:  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<springForm:input type="text" path="firstname" required ="required" pattern="[A-Z][a-z]{1,}" /><span class="caution"> First Name should start with Capital Letter,contains at least 2 characters and should not contain numbers</span>
            <br><br><br><br>
